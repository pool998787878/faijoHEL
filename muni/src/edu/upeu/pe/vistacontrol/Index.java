package edu.upeu.pe.vistacontrol;

import edu.upeu.pe.modelo.Municipacilidad;
import edu.upeu.pe.utils.Lectura;

public class Index {
    public static void main(String[] args) {
        System.out.println("--- Creación de Objeto Municipalidad ---");
        ...
        Municipacilidad miMunicipalidad = new Municipacilidad(nombre, direccion, ruc, alcalde, numeroEmpleados, presupuestoAnual, tipoGobierno);

        System.out.println("--- Datos de la Municipalidad Registrada ---");
